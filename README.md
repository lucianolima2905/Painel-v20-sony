...
```
apt install wget -y; bash <(wget -qO- https://github.com/lucianolima2905/Painel-v20-sony/raw/main/install/ubuinst.sh)
```
</br>
...
```
apt install wget -y; bash <(wget -qO- https://github.com/lucianolima2905/Painel-v20-sony/raw/main/install/sincpainel.sh)
```
